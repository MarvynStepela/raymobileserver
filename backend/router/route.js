...
import { addCars, deleteCarsID, editCarAvatar, editCars, getCarAvatar, getCars, getCarsID, getDriverCar } from "../controllers/cars.js";
...
import { createUser, editUser, getAllUsers, getUserID, lockUser, unLockockUser } from "../controllers/users.js";
import { checkTokenMiddleware } from "../middleware/auth_check.js";
import { Manquement, addVersement, getAllOrders, getAllVersement, getAllVersementByWeek, getOrderByCar, getOrderByDriver, getVoyageCar, getVoyageDriver } from "../controllers/order.js";
...
router.get("/api/cars/get-driver-car/:vehiculeId", getDriverCar);
...
router.get("/api/order/order-driver/:driverID", getOrderByDriver);
router.get("/api/order/trip-driver/:driverID", getVoyageDriver);
router.get("/api/order/order-car/:vehiculeID", getOrderByCar);
router.get("/api/order/trip-car/:vehiculeID", getVoyageCar);
...
router.put("/api/users/lock-user/:userid", lockUser);
router.put("/api/users/unlock-user/:userid", unLockockUser);
