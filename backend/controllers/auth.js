...
export const verifyMail = async (req, res) => {
  ...
  export function resendEmailVerify({ recipient_email, otp, administrateur }) {
    return new Promise((resolve, reject) => {
      let mailSubject = "RAY MOBILE CI Activation";
      const mailOptions = {
        from: EMAIL_USER,
        to: recipient_email,
        subject: mailSubject,
                                    ...
                                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:0 35px;">
                                                <h1 style="color:#2a2185; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Activation de compte RAY MOBILE CI</h1>
                                                <span
                                                    style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                    Bonjour ${administrateur}, </p>
                                                    <p>Nous vous remercions d'avoir choisi RAY MOBILE CI pour l'ouverture de votre compte. Veuillez utiliser le code OTP suivant pour terminer votre procédure de de création de compte. ce code OTP est valide pendant 1 minute
                                                </p>
                                  ...
                                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                      ...
                                      <tr>
                                          <td style="padding:0 35px;">
                                              ...
                                              <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                  Bonjour ${administrateur}, </p>
                                                  <p>Nous vous remercions d'avoir choisi RAY MOBILE CI pour l'ouverture de votre compte. <a href=${CLIENT_URL}>Veuillez cliquer sur içi</a> et suivre les instruction pour l'activation de votre compte.
                                              </p>
                                              <p style="font-size:0.9em;">Cordialement,<br />Dev-Pack's SARL</p>
                                              <hr style="border:none;border-top:1px solid #eee" />
                                              <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
  ...
  export const login = async (req,res) => {
    ...
    db.query(findUserQuery, [email], (err, data) => {
      ...
      // Compte Utilisateur non vérifié
      if (data[0].is_verified == 2) {
        return res.status(201).send({
          message: "Désolé votre compte est suspendu !",
          code: 105,
        });
      }
  ...
  export function sendEmailVerify({ recipient_email, otp, administrateur }) {
    return new Promise((resolve, reject) => {
      let mailSubject = "RAY MOBILE CI Récuperation de compte";
      const mailOptions = {
        from: EMAIL_USER,
        to: recipient_email,
        subject: mailSubject,
                          ...
                          <tr>
                              <td>
                                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                      ...
                                      <tr>
                                          <td style="padding:0 35px;">
                                              <h1 style="color:#2a2185; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Récupération de compte RAY MOBILE CI</h1>
                                              <span
                                                  style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                              <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                  Bonjour ${administrateur}, </p>
                                                  <p>Nous vous remercions d'avoir choisi RAY MOBILE CI. Vous souhaitez reinitialiser votre compte, veuillez utiliser le code OTP suivant et suivez les instructions pour recupérer votre compte. Ce code OTP est valide pendant 1 minute
                                              </p>
                                              <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
                                              <p style="font-size:0.9em;">Cordialement,<br />Dev-Pack's SARL</p>
                                              <hr style="border:none;border-top:1px solid #eee" />
